-- NOT CREATED BY ME
--CREDITS: Edge // Zwolf // Moon // Hunter // Toon // Peyton // ATP
...
Players.LocalPlayer.OnTeleport:Connect(function(State)
	if KeepInfYield and (not TeleportCheck) and queueteleport then
		TeleportCheck = true
		queueteleport("loadstring(game:HttpGet('https://raw.githubusercontent.com/jaeelin/Improved-Scripts/refs/heads/main/InfiniteYield.lua'))()")
	end
end)
...
addcmd("explorer", {"dex"}, function(args, speaker)
	notify("Loading", "Hold on a sec")
	loadstring(game:HttpGet("https://raw.githubusercontent.com/jaeelin/Improved-Scripts/refs/heads/main/DarkDex.lua"))()
end)
...
addcmd('remotespy',{'rspy'},function(args, speaker)
	...
	loadstring(game:HttpGet("https://raw.githubusercontent.com/jaeelin/Improved-Scripts/refs/heads/main/SimpleSpy.lua"))()
end)
